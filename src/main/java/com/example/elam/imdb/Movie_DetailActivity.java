...
public class Movie_DetailActivity extends AppCompatActivity implements View.OnClickListener
{
    ...
    class JSON_movieDetails extends AsyncTask<Void, Void, Void>
    {
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            try {
                str_movieImage = "http://image.tmdb.org/t/p/w500/8uO0gUM8aNqYLs1OsTBQiXu0fEv.jpg" + jsonObject.getString("poster_path");
        ...
        protected Void doInBackground(Void... params)
        {
            ...
            try {
                ...
                for (int i = 0; i < 7; i++)
                {
                    ...
                    str_moviePoster = "http://image.tmdb.org/t/p/w500/8uO0gUM8aNqYLs1OsTBQiXu0fEv.jpg" + jsonObject.getString("file_path");
